...
public class ArtPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize view
        final ImageView imageOfArt = (ImageView) findViewById(R.id.art_image_view);
        final TextView artistText = (TextView) findViewById(R.id.art_artist_text);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (bundleExtra != null) {
                    ...
                    artistText.setText(pieceOfArt.getArtist());
